...
### Backend Software Engineer | .NET, Distributed Systems & AI-Powered APIs

I design and build reliable backend systems that are easy to maintain, test, and scale. My work focuses on clear architecture, well-designed APIs, data-intensive services, and pragmatic engineering that solves real business problems.

## What I Can Help With

- ASP.NET Core and C# backend development
- REST API design, third-party integrations, and microservices
- Clean Architecture, Domain-Driven Design, Vertical Slice, and Hexagonal Architecture
...
Backend API development, architecture and refactoring, database-backed services, performance work, integrations, and AI-enabled document systems.

## Contact

- [LinkedIn](https://www.linkedin.com/in/ilhanodun/)
- [Email](mailto:ilhanodun34@gmail.com)
